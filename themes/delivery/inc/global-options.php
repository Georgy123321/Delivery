...
$opt_name = 'global_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Global Options', 'delivery' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Global Options', 'delivery' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'delivery' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'delivery' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'delivery' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'delivery' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'delivery' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'delivery' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'delivery' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'delivery' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'delivery' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'delivery' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header', 'delivery' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'Header Fields!', 'delivery' ),
		...
		'fields'           => array(
			array(
				...
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Header Logo', 'delivery' ),
				'desc'     => esc_html__( 'Upload Logo', 'delivery' ),
			),
			array(
				'id'       => 'header-mobile-logo',
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Header Mobile Logo', 'delivery' ),
				'desc'     => esc_html__( 'Upload Mobile Logo', 'delivery' ),
			),
			array(
				'id'       => 'header-phone',
				'type'     => 'text',
				'title'    => esc_html__( 'Phone', 'delivery' ),
			),
			array(
				'id'       => 'header-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Text', 'delivery' ),
			),
			array(
				'id'       => 'header-button-text',
				'type'     => 'text',
				'title'    => esc_html__( 'Header Button Text', 'delivery' ),
			),
		),
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Burger', 'delivery' ),
		'id'               => 'burger',
		'desc'             => esc_html__( 'Burger Fields!', 'delivery' ),
		'icon'             => 'el el-align-justify',
		'fields'           => array(
			array(
				'id'       => 'burger-button-text',
				'type'     => 'text',
				'title'    => esc_html__( 'Burger Button Text', 'delivery' ),
			),
		),
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer', 'delivery' ),
		'id'               => 'footer',
		'desc'             => esc_html__( 'Footer Fields!', 'delivery' ),
		...
		'fields'           => array(
			array(
				...
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Footer Logo', 'delivery' ),
				'desc'     => esc_html__( 'Upload Logo', 'delivery' ),
			),
			array(
				'id'       => 'footer-phone',
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'delivery' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'delivery' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'delivery' );
